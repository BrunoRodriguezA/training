...
class App(tk.Tk):
    ...
    def mostrar_formulario(self):
        ...
        # Apellido
        apellido = ttk.Label(self.frame_forma, text='Apellido: ')
        apellido.grid(row=1, column=0, sticky=tk.W, pady=30, padx=5)
        self.apellido_t = ttk.Entry(self.frame_forma)
        self.apellido_t.grid(row=1, column=1)
        
        # Membresia
        membresia = ttk.Label(self.frame_forma, text='Membresia: ')
        membresia.grid(row=2, column=0, sticky=tk.W, pady=30, padx=5)
        self.membresia_t = ttk.Entry(self.frame_forma)
        self.membresia_t.grid(row=2, column=1)
        
        # publicar el fram de forma 
    ...
    def mostrar_botones(self):
        ...
        # boton de limpiar
        limpiar_boton = ttk.Button(self.frame_botones, text='Limpiar', command=self.limpiar_formulario)
    ...
    def guardar_cliente(self):
        ...
        # validamos el valor del atributo de id lciente 
        if self.id_cliente is None:
            ...
            cliente = Cliente(id_cliente=self.id_cliente, nombre=nombre, apellido=apellido, membresia=membresia)
    ...
    def cargar_cliente(self,event):
        elemto_seleccionado = self.tabla.selection()[0]
        elemento = self.tabla.item(elemto_seleccionado)
        cliente_t = elemento['values'] # tupla de valores del ciente seleccionado
        # recuperar cada valodr del cliente 
        self.id_cliente = cliente_t[0]
        nombre = cliente_t[1]
        apellido = cliente_t[2]
        membresia = cliente_t[3]
        
        # antes de cargar, limpiamos formulario 
